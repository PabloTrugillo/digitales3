...
//El error en este programa era que el padre cierra el descriptor de salida antes de crear al hijo , entonces el hijo no hereda los descriptores de la tuberia y por eso el kernel manda la señal 
