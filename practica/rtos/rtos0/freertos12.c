...
#define TAM_COLA 10 //cantidad de mensajes
#define TAM_PILA 512
...
static void InitSerie(void)
{
	...
	cola_rec = xQueueCreate (TAM_COLA , sizeof (char));//puede tambien estar inicializada en el main, los argumentos son, cantidad e mensajes y tamaño d cada mensaje
	if( cola_rec == NULL ){
