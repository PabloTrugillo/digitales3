...
static void vTarea2(void *pvParameters)
{
  ...
  const TickType_t xDelay50ms = pdMS_TO_TICKS( 60UL );
   ...
   for( ;; ) {
      ...
      xSemaphoreTake( p_sem_b, portMAX_DELAY);//aca se bloquea esta tarea xq el sem ya estaba decre en la linea 84
...
static void vTarea1(void *pvParameters)
{
   ...
   for( ;; ) {
      ...
      printf( "%s Toma sem_b \r\n", pcTaskName );
      xSemaphoreTake( p_sem_a, portMAX_DELAY);//aca se va a bloq esta tarea xq se habia decr en la 62
