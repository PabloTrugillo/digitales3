...
//--- Copia Mensaje en la memoria
   memcpy(ptr, MENSAJE_B, sizeof(MENSAJE_B));	//Copia áreas de memoria
														//Destino: ptr	
														//Origen: MENSAJE
														//Longitud: sizeof(MENSAJE)

   printf ("\nMENSAJE copiado en memoria\n");
...
//--- ABRE el OBJETO de memoria compartida, y obtiene el descriptor
 ...
 //--- Se mapea la memoria compartida al espacio de memoria de este proceso
...
//---- Se abre el semaforo creado por el proceso A, los ultimos dos campos se ignoran porque el semáforo fue creado por dicho proceso
